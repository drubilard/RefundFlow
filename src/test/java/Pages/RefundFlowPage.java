...
public class RefundFlowPage extends LoadableComponent<RefundFlowPage> {
	...
	private WebElement postReembolsarButtonLocator;
	...
	public void mantenedorReembolso() throws InterruptedException {
		...
		automator.waitUntilPresent(logoutLocator, 10);
		automator.click(postCobrarButtonLocator, 10);
		automator.click(postReembolsarButtonLocator, 10);

	}

	// creacion de solicitud de reembolsos
	public boolean crearReembolso() throws InterruptedException {
	...
	public boolean aceptarReembolso() {
